...
#1) NFLX by month , NFLX_daily by Daily
#2) NFLX shows daily price , NFLX_Daily shows Monthly price
#3) Netflix_stocks shows monthly price , Netflix_stocks_quarterly shows Daily(Mon to Fri) price
